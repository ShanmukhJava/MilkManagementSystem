...
<body>
    <div class="container mt-5">
        <h1>Add Entity</h1>
        <form:form action="/entities/add" method="post" modelAttribute="entity" id="entityForm" class="needs-validation" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-row">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <div class="form-check">
                    <form:radiobutton path="gender" id="male" value="Male" class="form-check-input"/>
                    <label class="form-check-label" for="male">Male</label>
                </div>
                <div class="form-check">
                    <form:radiobutton path="gender" id="female" value="Female" class="form-check-input"/>
             ...
             <div class="form-group">
                ...
                <div class="form-check">
                    <form:checkbox path="interests" value="Sports" id="sports" class="form-check-input"/>
                    <label class="form-check-label" for="sports">Sports</label>
                </div>
                <div class="form-check">
                    <form:checkbox path="interests" value="Music" id="music" class="form-check-input"/>
                    <label class="form-check-label" for="music">Music</label>
                </div>
                <div class="form-check">
                    <form:checkbox path="interests" value="Reading" id="reading" class="form-check-input"/>
